...
##### Total #####
comment <- paste(
  "I have tallied " , total_victims, " victims across ", total_incidents, 
  " incidents, with drivers killing ", total_deaths, " and wounding ", total_injuries, ".","\n\n",
  total_crit, "/",total_injuries, " injuries were critical or life-threatening. ",total_serious_major_injuries,"/",total_injuries,
...
##### Breakdown #####
comment <- paste(
  "Drivers have killed ", total_ped_deaths, " pedestrians, ", total_cyc_deaths, " cyclists, and ", total_oth_deaths, " others (e.g. road workers, roadside service)",
